...
const TERMINAL_WORKLOAD = new Set(["completed", "failed", "cancelled", "evidence-incomplete", "not_applicable"]);
...
function normalizeRecord(record) {
  ...
  if (TERMINAL_WORKLOAD.has(workloadStatus) && !ACTIVE_ALLOCATION.has(allocationStatus) && record.finishedAt === null) throw new Error("terminal execution registry record requires finishedAt");
